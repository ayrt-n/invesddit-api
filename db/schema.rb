...
ActiveRecord::Schema[7.0].define(version: 20_230_509_105_238) do
  ...
  create_enum 'comments_status', %w[published deleted]
  create_enum 'notification_category', %w[comment reply]
  create_enum 'posts_status', %w[published deleted]
  ...
  create_table 'memberships', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[account_id community_id role], name: 'index_memberships_on_account_id_and_community_id_and_role',
                                              unique: true
    t.index %w[account_id community_id], name: 'index_memberships_on_account_id_and_community_id'
  ...
  create_table 'votes', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[account_id votable_id votable_type],
            name: 'index_votes_on_account_id_and_votable_id_and_votable_type', unique: true
